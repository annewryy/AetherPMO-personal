...
--              (6 stages, 18 activities, 40 artifact templates).
-- ============================================================================
...
BEGIN
    ...
    ON CONFLICT (template_id, stage_code) DO UPDATE SET stage_name = EXCLUDED.stage_name, full_name = EXCLUDED.full_name
    ...
    ON CONFLICT (stage_id, activity_code) DO UPDATE SET activity_name = EXCLUDED.activity_name RETURNING id INTO v_act_id;
    ...
    ON CONFLICT (activity_id, artifact_name) DO UPDATE SET is_mandatory = EXCLUDED.is_mandatory;
